...
namespace :close do
  ...
  task sync: :environment do
    ...
    # 8. Sets 'yes' in 'Ready for Email' based on AI decision using
    # nurture start date, customer segment and if the link was clicked
    TagReadyForEmailInCloseJob.perform_later

    # 9. Sorts the contacts in 'Inbox', 'Needs Contacts', 'Nurturing Contacts' and 'Retry Sequence'
    SortOpportunitiesInCloseJob.perform_later

    # 10. Subscribes contacts to sequence for opportunities in 'Ready For Sequence' status
